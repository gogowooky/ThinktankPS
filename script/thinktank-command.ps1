...
#''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
$global:ttcmd_application_developping_extract_keyword_containing_memo = {
    #.SYNOPSIS
    # キーワードを含むメモのライブラリを作成する

    $script:desk.create_cache( "" )
}
$global:ttcmd_application_developping_debug = {
    #.SYNOPSIS
    # デバッグ用
...
#''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
$global:ttcmd_application_borderstyle_all = {
    #.SYNOPSIS
    # 全パネルを表示する
...
$global:ttcmd_application_borderstyle_standard = {
    #.SYNOPSIS
    # 標準敵な表示
...
$global:ttcmd_application_borderstyle_workplace = {
    #.SYNOPSIS
    # WorkPlaceのみ表示する
...
$global:ttcmd_application_borderstyle_work = {
    #.SYNOPSIS
    # Workのみ表示する
...
$global:ttcmd_application_borderstyle_turn_norm = {
    #.SYNOPSIS
    # レイアウト表示を変更する
...
$global:ttcmd_application_borderstyle_turn_rev = {
    #.SYNOPSIS
    # レイアウト表示を変更する（逆方向）
...
$global:ttcmd_application_border_inwindow_left = {
    #.SYNOPSIS
    # Window内境界を左へ移動

    $script:app.border( 'Layout.Guide.Width', "-1" )
}
$global:ttcmd_application_border_inwindow_right = {
    #.SYNOPSIS
    # Window内境界を右へ移動

    $script:app.border( 'Layout.Guide.Width', "+1" )
}
$global:ttcmd_application_border_inguide_up = {
    #.SYNOPSIS
    # Guide内境界を上へ移動

    $script:app.border( 'Layout.Library.Height', "-1" )
}
$global:ttcmd_application_border_inguide_down = {
    #.SYNOPSIS
    # Guide内境界を下へ移動

    $script:app.border( 'Layout.Library.Height', "+1" )
}
$global:ttcmd_application_border_inworkplace_up = {
    #.SYNOPSIS
    # Workplace内境界を上へ移動

    $script:app.border( 'Layout.Shelf.Height', "-1" )
}
$global:ttcmd_application_border_inworkplace_down = {
    #.SYNOPSIS
    # Workplace内境界を下へ移動

    $script:app.border( 'Layout.Shelf.Height', "+1" )
}
$global:ttcmd_application_border_indesk_up = {
    #.SYNOPSIS
    # Desk内境界を上へ移動

    $script:app.border( 'Layout.Work1.Height', "-1" )
}
$global:ttcmd_application_border_indesk_down = {
    #.SYNOPSIS
    # Desk内境界を下へ移動
...
$global:ttcmd_application_border_indesk_left = {
    #.SYNOPSIS
    # Desk内境界を左へ移動

    $script:app.border( 'Layout.Work1.Width', "-1" )
}
$global:ttcmd_application_border_indesk_right = {
    #.SYNOPSIS
    # Desk内境界を右へ移動
...
#''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
$global:ttcmd_application_window_quit = {
    #.SYNOPSIS
    # アプリケーションを終了する
...
$global:ttcmd_application_window_full = {
    #.SYNOPSIS
    # アプリケーションを最大化する
    
    $script:app.window('max')
}
$global:ttcmd_application_window_icon = {
    #.SYNOPSIS
    # アプリケーションを最小化する

    $script:app.window('min')
}
$global:ttcmd_application_window_free = {
    #.SYNOPSIS
    # アプリケーションを通常化する

    $script:app.window('normal')
}
$global:ttcmd_application_window_turn = {
    #.SYNOPSIS
    # アプリケーション表示を変更する
...
#''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
$global:ttcmd_application_help_site = {
    #.SYNOPSIS
    # アプリケーションサイトを表示する

    $script:app.dialog( 'site' )
}
$global:ttcmd_application_help_version = {
    #.SYNOPSIS
    # アプリケーションのバージョン表示

    $script:app.dialog( 'version' )
}
$global:ttcmd_application_help_shortcuts = {
    #.SYNOPSIS
    # アプリケーションのショートカットキー一覧表示

    $script:app.dialog( 'shortcut' )
}
$global:ttcmd_application_help_instruction = {
    #.SYNOPSIS
    # アプリケーションを使い方表示

    $script:app.dialog( 'help' )
}
$global:ttcmd_application_help_breifing = {
    #.SYNOPSIS
    # アプリケーションの説明
...
#''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
$global:ttcmd_application_textsearch = {
    #.SYNOPSIS
    # 全文検索を実行する
...
$global:ttcmd_application_commands_execute = {
    #.SYNOPSIS
    # コマンドを選択して実行する
...
#region　Library
#########################################################################################################################
$global:ttcmd_library_invoke_item = {
    #.SYNOPSIS
    # 選択アイテムを実行する(library)
...
$global:ttcmd_library_activate_item = {
    #.SYNOPSIS
    # 選択アイテムを実行する(library)
...
$global:ttcmd_library_delete_selected = {
    #.SYNOPSIS
...
$global:ttcmd_library_turn_norm = {
    #.SYNOPSIS
...
$global:ttcmd_library_move_up = {
    #.SYNOPSIS
    # Libraryのカーソルを上に移動
    
    $script:library.cursor('up')
}
$global:ttcmd_library_move_down = {
    #.SYNOPSIS
    # Libraryのカーソルを下に移動

    $script:library.cursor('down')
}
$global:ttcmd_library_move_first = {
    #.SYNOPSIS
    # Libraryのカーソルを先頭に移動

    $script:library.cursor('first')
}
$global:ttcmd_library_move_last = {
    #.SYNOPSIS
    # Libraryのカーソルを末尾に移動

    $script:library.cursor('last')
}
$global:ttcmd_library_filter_clear = {
    #.SYNOPSIS
    # Libraryのフィルターをクリアする
    $script:library.nosearch()
}
$global:ttcmd_library_sort_dsc_1stcolumn = {
    #.SYNOPSIS
    # Libraryの第１カラムでソートする

    $script:library.column('1').sort('Descending')
}
$global:ttcmd_library_sort_dsc_2ndcolumn = {
    #.SYNOPSIS
    # Libraryの第２カラムでソートする

    $script:library.column('2').sort('Descending')
}
$global:ttcmd_library_sort_dsc_3rdcolumn = {
    #.SYNOPSIS
    # Libraryの第３カラムでソートする

    $script:library.column('3').sort('Descending')
}
$global:ttcmd_library_sort_dsc_4thcolumn = {
    #.SYNOPSIS
    # Libraryの第４カラムでソートする

    $script:library.column('4').sort('Descending')
}
$global:ttcmd_library_sort_dsc_5thcolumn = {
    #.SYNOPSIS
    # Libraryの第５カラムでソートする

    $script:library.column('5').sort('Descending')
}
$global:ttcmd_library_sort_dsc_6thcolumn = {
    #.SYNOPSIS
    # Libraryの第６カラムでソートする

    $script:library.column('6').sort('Descending')
}
$global:ttcmd_library_sort_asc_1stcolumn = {
    #.SYNOPSIS
    # Libraryの第１カラムでソートする

    $script:library.column('1').sort('Ascending')
}
$global:ttcmd_library_sort_asc_2ndcolumn = {
    #.SYNOPSIS
    # Libraryの第２カラムでソートする

    $script:library.column('2').sort('Ascending')
}
$global:ttcmd_library_sort_asc_3rdcolumn = {
    #.SYNOPSIS
    # Libraryの第３カラムでソートする

    $script:library.column('3').sort('Ascending')
}
$global:ttcmd_library_sort_asc_4thcolumn = {
    #.SYNOPSIS
    # Libraryの第４カラムでソートする

    $script:library.column('4').sort('Ascending')
}
$global:ttcmd_library_sort_asc_5thcolumn = {
    #.SYNOPSIS
    # Libraryの第５カラムでソートする

    $script:library.column('5').sort('Ascending')
}
$global:ttcmd_library_sort_asc_6thcolumn = {
    #.SYNOPSIS
    # Libraryの第６カラムでソートする
...
$global:ttcmd_library_select_memo = {
    #.SYNOPSIS
    # LibraryでMemoを選択する

    $script:library.cursor( 'Memo' )
}
$global:ttcmd_library_select_link = {
    #.SYNOPSIS
    # LibraryでLinkを選択する

    $script:library.cursor( 'Link' )
}
$global:ttcmd_library_select_search = {
    #.SYNOPSIS
    # LibraryでSearchを選択する
...
$global:ttcmd_index_delete_selected = {
    #.SYNOPSIS
    # 選択Indexを削除する
...
$global:ttcmd_index_selected_tocurrenteditor = {
    #.SYNOPSIS
    # 選択メモをカレントエディタに読み込む
...
$global:ttcmd_index_invoke_item = {
    #.SYNOPSIS
    # 選択アイテムを実行する(index)
...
$global:ttcmd_index_activate_item = {
    #.SYNOPSIS
    # 選択アイテムを実行する(index)
...
$global:ttcmd_index_selected_toeditor1 = {
    #.SYNOPSIS
...
$global:ttcmd_index_selected_toeditor2 = {
    #.SYNOPSIS
...
$global:ttcmd_index_selected_toeditor3 = {
    #.SYNOPSIS
...
$global:ttcmd_index_move_up = {
    #.SYNOPSIS
    # Indexのカーソルを上に移動

    $script:index.cursor('up')
}
$global:ttcmd_index_move_down = {
    #.SYNOPSIS
    # Indexのカーソルを下に移動

    $script:index.cursor('down')
}
$global:ttcmd_index_move_first = {
    #.SYNOPSIS
    # Indexのカーソルを先頭に移動

    $script:index.cursor('first')
}
$global:ttcmd_index_move_last = {
    #.SYNOPSIS
    # Indexのカーソルを末尾に移動

    $script:index.cursor('last')
}
$global:ttcmd_index_filter_clear = {
    #.SYNOPSIS
    # Indexの検索キーワードを消去する

    $script:index.nosearch()
}
$global:ttcmd_index_sort_dsc_1stcolumn = {
    #.SYNOPSIS
    # Indexの第１カラムでソートする

    $script:index.column('1').sort('Descending')
}
$global:ttcmd_index_sort_dsc_2ndcolumn = {
    #.SYNOPSIS
    # Indexの第２カラムでソートする

    $script:index.column('2').sort('Descending')
}
$global:ttcmd_index_sort_dsc_3rdcolumn = {
    #.SYNOPSIS
    # Indexの第３カラムでソートする

    $script:index.column('3').sort('Descending')
}
$global:ttcmd_index_sort_dsc_4thcolumn = {
    #.SYNOPSIS
    # Indexの第３カラムでソートする

    $script:index.column('4').sort('Descending')
}
$global:ttcmd_index_sort_dsc_5thcolumn = {
    #.SYNOPSIS
    # Indexの第５カラムでソートする

    $script:index.column('5').sort('Descending')
}
$global:ttcmd_index_sort_dsc_6thcolumn = {
    #.SYNOPSIS
    # Indexの第６カラムでソートする

    $script:index.column('6').sort('Descending')
}
$global:ttcmd_index_sort_asc_1stcolumn = {
    #.SYNOPSIS
    # Indexの第１カラムでソートする

    $script:index.column('1').sort('Ascending')
}
$global:ttcmd_index_sort_asc_2ndcolumn = {
    #.SYNOPSIS
    # Indexの第２カラムでソートする

    $script:index.column('2').sort('Ascending')
}
$global:ttcmd_index_sort_asc_3rdcolumn = {
    #.SYNOPSIS
    # Indexの第３カラムでソートする

    $script:index.column('3').sort('Ascending')
}
$global:ttcmd_index_sort_asc_4thcolumn = {
    #.SYNOPSIS
    # Indexの第３カラムでソートする

    $script:index.column('4').sort('Ascending')
}
$global:ttcmd_index_sort_asc_5thcolumn = {
    #.SYNOPSIS
    # Indexの第５カラムでソートする

    $script:index.column('5').sort('Ascending')
}
$global:ttcmd_index_sort_asc_6thcolumn = {
    #.SYNOPSIS
    # Indexの第６カラムでソートする
...
$global:ttcmd_shelf_invoke_item = {
    #.SYNOPSIS
    # 選択アイテムを実行する（shelf）
...
$global:ttcmd_shelf_activate_item = {
    #.SYNOPSIS
    # 選択アイテムを実行する（shelf）
...
$global:ttcmd_shelf_delete_selected = {
    #.SYNOPSIS
    # 選択Indexを削除する
...
$global:ttcmd_shelf_selected_tocurrenteditor = {
    #.SYNOPSIS
    # 選択メモをカレントエディタに読み込む
...
$global:ttcmd_shelf_selected_toeditor3 = {
    #.SYNOPSIS
    # 選択メモをエディタ３に読み込む
...
$global:ttcmd_shelf_selected_toeditor2 = {
    #.SYNOPSIS
    # 選択メモをエディタ２に読み込む
...
$global:ttcmd_shelf_selected_toeditor1 = {
    #.SYNOPSIS
    # 選択メモをエディタ１に読み込む
...
$global:ttcmd_shelf_move_up = {   
    #.SYNOPSIS
    # Shelfのカーソルを上に移動

    $script:shelf.cursor('up')
}
$global:ttcmd_shelf_move_down = {   
    #.SYNOPSIS
    # Shelfのカーソルを下に移動

    $script:shelf.cursor('down')
}
$global:ttcmd_shelf_move_first = {   
    #.SYNOPSIS
    # Shelfのカーソルを先頭に移動

    $script:shelf.cursor('first')
}
$global:ttcmd_shelf_move_last = {   
    #.SYNOPSIS
    # Shelfのカーソルを最後に移動

    $script:shelf.cursor('last')
}
$global:ttcmd_shelf_clear = {
    #.SYNOPSIS
    # Shelfのフィルターをクリアする

    $script:shelf.nosearch()
}
$global:ttcmd_shelf_sort_dsc_1stcolumn = {
    #.SYNOPSIS
    # Shelfの第１カラムでソートする

    $script:shelf.column('1').sort('Descending')
}
$global:ttcmd_shelf_sort_dsc_2ndcolumn = {
    #.SYNOPSIS
    # Shelfの第２カラムでソートする

    $script:shelf.column('2').sort('Descending')
}
$global:ttcmd_shelf_sort_dsc_3rdcolumn = {
    #.SYNOPSIS
    # Shelfの第３カラムでソートする

    $script:shelf.column('3').sort('Descending')
}
$global:ttcmd_shelf_sort_dsc_4thcolumn = {
    #.SYNOPSIS
    # Shelfの第４カラムでソートする

    $script:shelf.column('4').sort('Descending')
}
$global:ttcmd_shelf_sort_dsc_5thcolumn = {
    #.SYNOPSIS
    # Shelfの第５カラムでソートする

    $script:shelf.column('5').sort('Descending')
}
$global:ttcmd_shelf_sort_dsc_6thcolumn = {
    #.SYNOPSIS
    # Shelfの第６カラムでソートする

    $script:shelf.column('6').sort('Descending')
}
$global:ttcmd_shelf_sort_asc_1stcolumn = {
    #.SYNOPSIS
    # Shelfの第１カラムでソートする

    $script:shelf.column('1').sort('Ascending')
}
$global:ttcmd_shelf_sort_asc_2ndcolumn = {
    #.SYNOPSIS
    # Shelfの第２カラムでソートする

    $script:shelf.column('2').sort('Ascending')
}
$global:ttcmd_shelf_sort_asc_3rdcolumn = {
    #.SYNOPSIS
    # Shelfの第３カラムでソートする

    $script:shelf.column('3').sort('Ascending')
}
$global:ttcmd_shelf_sort_asc_4thcolumn = {
    #.SYNOPSIS
    # Shelfの第４カラムでソートする

    $script:shelf.column('4').sort('Ascending')
}
$global:ttcmd_shelf_sort_asc_5thcolumn = {
    #.SYNOPSIS
    # Shelfの第５カラムでソートする

    $script:shelf.column('5').sort('Ascending')
}
$global:ttcmd_shelf_sort_asc_6thcolumn = {
    #.SYNOPSIS
    # Shelfの第６カラムでソートする
...
#region　Desk Border
#''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
$global:ttcmd_desk_borderstyle_turn_norm = {
    #.SYNOPSIS
    # Deskにフォーカスする
...
$global:ttcmd_desk_borderstyle_turn_rev = {
    #.SYNOPSIS
    # Deskにフォーカスする
...
$global:ttcmd_desk_borderstyle_work123 = {
    #.SYNOPSIS
    # ３つのWorkplaceを表示
...
$global:ttcmd_desk_borderstyle_work12 = {
    #.SYNOPSIS
    # 横２つのWorkplaceを表示
...
$global:ttcmd_desk_borderstyle_work13 = {
    #.SYNOPSIS
    # 縦２つのWorkplaceを表示
...
$global:ttcmd_deskwork_turn_norm = {
    #.SYNOPSIS
    # Work表示を切り替える
...
$global:ttcmd_deskwork_turn_rev = {
    #.SYNOPSIS
    # Work表示を切り替える（逆順）
...
$global:ttcmd_desk_borderstyle_work1 = {
    #.SYNOPSIS
    # Work1を表示
...
$global:ttcmd_desk_borderstyle_work2 = {
    #.SYNOPSIS
    # Work2を表示
...
$global:ttcmd_desk_borderstyle_work3 = {
    #.SYNOPSIS
    # Work3を表示
...
#region　Desk Works
#''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
$global:ttcmd_desk_focus_menu = {
    #.SYNOPSIS
    # deskのメニューにフォーカスする

    $script:desk._sorting.Items[0].focus()
}
$global:ttcmd_desk_works_focus_turn_norm = {
    #.SYNOPSIS
    # Workのフォーカスを切り替える
...
$global:ttcmd_desk_works_focus_turn_rev = {
    #.SYNOPSIS
...
$global:ttcmd_desk_works_focus_work1 = {
    #.SYNOPSIS
    # Work1にフォーカスする
...
$global:ttcmd_desk_works_focus_work2 = {
    #.SYNOPSIS
    # Work2にフォーカスする
...
$global:ttcmd_desk_works_focus_work3 = {
    #.SYNOPSIS
    # Work3にフォーカスする
...
#region　Config
#########################################################################################################################
$global:ttcmd_application_config_editor_wordwrap_on = {
    #.SYNOPSIS
    # カレントエディタのワードラップをON
...
$global:ttcmd_application_config_editor_wordwrap_off = {
    #.SYNOPSIS
    # カレントエディタのワードラップをOFF
...
$global:ttcmd_application_config_editor_wordwrap_toggle = {
    #.SYNOPSIS
...
$global:ttcmd_application_config_editor_staycursor_on = {
    #.SYNOPSIS
...
$global:ttcmd_application_config_editor_staycursor_off = {
    #.SYNOPSIS
...
$global:ttcmd_application_config_editor_staycursor_toggle = {
    #.SYNOPSIS
...
$global:ttcmd_application_config_app_keydown_message_on = {
    #.SYNOPSIS
    # アプリのキーダウンメッセージをON

    $script:app._set( "Config.KeyDownMessage", "True" )
}
$global:ttcmd_application_config_app_keydown_message_off = {
    #.SYNOPSIS
    # アプリのキーダウンメッセージをOFF

    $script:app._set( "Config.KeyDownMessage", "False" )
}
$global:ttcmd_application_config_app_taskexpired_message_on = {
    #.SYNOPSIS
    # アプリのタスク終了メッセージをON

    $script:app._set( "Config.TaskExpiredMessage", "True" )
}
$global:ttcmd_application_config_app_taskexpired_message_off = {
    #.SYNOPSIS
    # アプリのタスク終了メッセージをOFF

    $script:app._set( "Config.TaskExpiredMessage", "False" )
}
$global:ttcmd_application_config_app_memosaved_message_on = {
    #.SYNOPSIS
    # メモのセーブメッセージをON

    $script:app._set( "Config.MemoSavedMessage", "True" )
}
$global:ttcmd_application_config_app_memosaved_message_off = {
    #.SYNOPSIS
    # メモのセーブメッセージをOFF

    $script:app._set( "Config.MemoSavedMessage", "False" )
}
$global:ttcmd_application_config_app_cachesaved_message_on = {
    #.SYNOPSIS
    # キャッシュのセーブメッセージをON

    $script:app._set( "Config.CacheSavedMessage", "True" )
}
$global:ttcmd_application_config_app_cachesaved_message_off = {
    #.SYNOPSIS
    # キャッシュのセーブメッセージをOFF
...
#region　Editor Edit
#########################################################################################################################
$global:ttcmd_editor_history_previous_tocurrenteditor = {
    #.SYNOPSIS
    # 前のファイルを開く
...
$global:ttcmd_editor_history_next_tocurrenteditor = {
    #.SYNOPSIS
    # 先のファイルを開く
...
$global:ttcmd_desk_works_focus_current_norm = {
    #.SYNOPSIS
    # カレントエディタにフォーカスする
...
$global:ttcmd_desk_works_focus_current_rev = {
    #.SYNOPSIS
    # カレントエディタにフォーカスする（逆順）
...
$global:ttcmd_editor_focus_currenteditor = {
    #.SYNOPSIS
    # カレントエディタにフォーカスする
...
$global:ttcmd_editor_new_tocurrenteditor = {
    #.SYNOPSIS
...
$global:ttcmd_editor_move_tonextkeyword = {
    #.SYNOPSIS
    # カーソルを次のキーワードに移動する
...
$global:ttcmd_editor_edit_delete = {
    #.SYNOPSIS
    # カーソルの右を削除する

    $script:desk.tool( 'Editor' ).edit( 'delete' )
}
$global:ttcmd_editor_edit_backspace = {
    #.SYNOPSIS
    # カーソルの左を削除する

    $script:desk.tool( 'Editor' ).edit( 'backspace' )
}
$global:ttcmd_editor_edit_insert_clipboard( $modkey, $key ) = {
    #.SYNOPSIS
    # クリップボードの内容を貼り付ける

    [TTClipboard]::PasteTo( $script:DocMan.current_editor, $modkey, $key )
}
$global:ttcmd_editor_edit_insert_date( $mod, $key ) = {
    #.SYNOPSIS
    # 日付タグを挿入する
...
$global:ttcmd_editor_edit_turn_bullet_norm = {
    #.SYNOPSIS
    # カーソル位置にアイテムヘッダーを挿入する

    $script:desk.tool( 'Editor' ).edit('bullet_nor')
}
$global:ttcmd_editor_edit_turn_bullet_rev = {
    #.SYNOPSIS
    # カーソル位置にアイテムヘッダーを挿入する

    $script:desk.tool( 'Editor' ).edit('bullet_rev')
}
$global:ttcmd_editor_outline_insert_section = {
    #.SYNOPSIS
    # カーソル位置にセクションを挿入する
...
#########################################################################################################################
$global:ttcmd_editor_outline_moveto_next = {
    #.SYNOPSIS
    # カーソルを次ののセクションに移動する

    $script:desk.tool( 'Editor' ).move_to( 'nextnode' )
}
$global:ttcmd_editor_outline_moveto_previous = {
    #.SYNOPSIS
    # カーソルを前のセクションへ移動する

    $script:desk.tool( 'Editor' ).move_to( 'prevnode' )
}
$global:ttcmd_editor_outline_fold_section = {
...
$global:ttcmd_editor_outline_collapse_section = {
    #.SYNOPSIS
    # セクションを展開する

    $script:desk.tool( 'Editor' ).node_to( 'open' )
}
$global:ttcmd_editor_outline_fold_allsection = {
    #.SYNOPSIS
    # 全セクションを折り畳む

    $script:desk.tool( 'Editor' ).node_to( 'close_all' )
}
$global:ttcmd_editor_outline_collapse_allsection = {
    #.SYNOPSIS
    # 全セクションを展開する
...
#region　Editor Tag
#########################################################################################################################
$global:ttcmd_editor_change_focus( $mod, $key ) = {
    #.SYNOPSIS
    # エディターのフォーカスを変更する
...
$global:ttcmd_editor_tag_invoke = {
    #.SYNOPSIS
    # タグを実行する
...
$global:ttcmd_editor_copy_tag_atcursor = {
    #.SYNOPSIS
